    ...
    <div className="page-div">
      ...
      <section className="about-me">
        ...
        <h2>
          ...
          during these unprecedented times will lead to fatigue, severe stress,
          and eventually burn out. Taking time for yourself, stepping away from
          the computer, and incorporating these yoga poses into your daily
          routine will greatly benefit your mental, physical and emotional
          health.
          <br></br>
          <br></br>
          Please take advantage of this site as a way to stay healthy, happy and
          productive!
        </h2>
      </section>
    </div>
